...
mister Fibonacci has at least a bigger brother. If not, give it a quick look to
get how things work.
...
of X elements - and remember each next element is the sum of the last X
elements - and returns the first n elements of the so seeded sequence.
